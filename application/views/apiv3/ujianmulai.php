        ...
        <div class="row">
            ...
            <div class="">
                <form role="form" name="_form" method="post" id="_form">
                    <input type="hidden" name="_ujian_id" id="_ujian_id" value="<?php echo $id;?>">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    foreach($soal as $item){
                                        ...
                                        $html .= '<div class="soal">'.html_entity_decode( $item['soal_text_judul'] ).'</div>';
                                        ...
                                        if( $item['soal_jenis'] == 'essay' ){
                                            ...
                                            for($j = 0; $j<=4; $j++){
                                                ...
                                                $jawaban = empty($item['soal_text_opsi'.$opsox]) ? '-' : $item['soal_text_opsi'.$opsox];
                                                ...
                                                $html .= '<label for="'.$opsional.'"><div class="huruf_opsi">'.strtoupper($opsi2[$j]).'</div><div class="huruf_opsi_jawaban"><p></p>'.html_entity_decode( $jawaban ).'<p></p></div></label>';
                                                $html .= '</div>';
                                            }
...
<script type="text/javascript">
    ...
    function simpan_akhir_done() {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url(); ?>apiv3/ujiansimpanakhir?id="+id,
            dataType: 'json',
            beforeSend: function() {
                $('.ajax-loading').show();
            },
    ...
    function simpan() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>apiv3/ujiansimpansatu?id="+id,
